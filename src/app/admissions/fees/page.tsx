...
export default function FeeStructurePage() {
  ...
  const activePage = "fees"; // ⭐ CURRENT PAGE
    ...
    <li>
      ...
      >
        ...
        <div className="text-left max-w-3xl mt-12">
          ...
          <p className="text-lg md:text-xl">
            Detailed information about school fees and programs
          </p>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 md:px-16 py-16">
        <p className="text-gray-700 text-lg">
          Fee structure details for all classes and programs. This page is fully
          integrated with the Admissions submenu for easy navigation.
        </p>
      </section>
    </div>
  );
