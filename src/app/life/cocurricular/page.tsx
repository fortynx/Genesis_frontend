...
export default function CoCurricularPage() {
  ...
  const activePage = "cocurricular"; // CURRENT PAGE
  ...
  return (
    ...
    <li>
      ...
      <section className="max-w-6xl mx-auto px-6 md:px-16 py-16">
        <h2 className="text-3xl font-bold text-green-900 mb-6">Our Co-Curricular Programs</h2>
        <p className="text-gray-700 text-lg leading-relaxed mb-8">
          We provide diverse co-curricular activities to help students develop creativity, teamwork, and leadership skills.
        </p>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {contentSubjects.map((subject, i) => (
            <div key={i} className="bg-white p-6 rounded-xl shadow-lg">
              <h3 className="text-xl font-bold text-green-800 mb-2">{subject}</h3>
              <p className="text-gray-600">
                Engaging programs designed to foster skills beyond the classroom.
              </p>
            </div>
          ))}
        </div>
