...
export default function CampusesPage() {
  ...
  const activePage = "campuses";
    const campuses = [
    {
      title: "Main Campus",
      description:
        "Our flagship campus with world-class facilities and modern learning spaces.",
    },
    {
      title: "Early Learning Campus",
      description:
        "A safe, nurturing environment designed for foundational learning.",
    },
    {
      title: "Sports & Activity Campus",
      description:
        "Dedicated infrastructure for physical education, arts, and extracurricular training.",
    },
  ];
  ...
  const academicsDropdown = [
    ...
    { title: "Secondary", href: "/academics/high" },
  ];
    ...
    <ul className="ml-4 mt-2 space-y-2">
      {aboutDropdownItems.map((dd) => (
        ...
        <div className="text-left max-w-3xl">
          ...
          <p className="text-lg md:text-xl">About us: Our Campuses</p>
        </div>
      </section>

      {/* CONTENT SECTION */}
      <section className="max-w-6xl mx-auto px-6 md:px-16 py-16">
        <h2 className="text-3xl font-bold text-green-900 mb-8">Discover Our Campuses</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {campuses.map((campus, idx) => (
            <div key={idx} className="bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl">
              <h3 className="text-xl font-semibold text-green-800 mb-2">{campus.title}</h3>
