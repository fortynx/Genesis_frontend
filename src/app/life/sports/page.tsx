...
export default function SportsPage() {
  ...
  const activePage = "sports"; // CURRENT PAGE
  ...
  return (
    ...
    <li>
      ...
      >
        ...
        <div className="text-left max-w-3xl mt-12">
          ...
          <p className="text-lg md:text-xl">
            Explore our games and student activities
          </p>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 md:px-16 py-16">
        <h2 className="text-3xl font-bold text-green-900 mb-8">Sports Programs</h2>
        <p className="text-gray-700">
          Our sports programs focus on building teamwork, fitness, and a healthy competitive spirit among students.
        </p>
      </section>
    </div>
  );
